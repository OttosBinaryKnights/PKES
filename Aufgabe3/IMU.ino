...
// Gyro Rates
  //int gx= MPU9150_read(MPU9150_GYRO_XOUT_L, MPU9150_GYRO_XOUT_H);  //not needed
  //int gy= MPU9150_read(MPU9150_GYRO_YOUT_L, MPU9150_GYRO_YOUT_H);  //not needed
  int gz= MPU9150_read(MPU9150_GYRO_ZOUT_L, MPU9150_GYRO_ZOUT_H);
...
void MPU9150_write(int addr, int data){
